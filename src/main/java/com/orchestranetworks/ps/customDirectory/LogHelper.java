...
public class LogHelper {
	...
	public final static LoggingCategory customDirectoryPerformanceLog = LoggingCategoryHelper.getLoggingCategory(Category.getInstance("log.performance.customDirectory"));
}
